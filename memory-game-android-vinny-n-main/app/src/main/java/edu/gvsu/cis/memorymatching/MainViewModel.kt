...
class MainViewModel : ViewModel() {
    ...
    fun addGameStat(stat: GameStat) {
        _gameStats.update { currentList ->
            (currentList + stat).sortedBy { it.numMoves } // default sort by moves
        }
    }

    fun sortStatsByMoves() {
        _gameStats.update { currentList -> currentList.sortedBy { it.numMoves } }
    }

    fun sortStatsByDuration() {
        _gameStats.update { currentList -> currentList.sortedBy { it.duration } }
    }
